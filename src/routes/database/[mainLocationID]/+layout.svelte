...
<section class="isolate container">
	<div class="sticky inset-0 top-16 z-40 flex justify-between sm:top-18">
		<div><MainLocationInfo /></div>
		<div
			class="bg-background dark:bg-dark-background flex h-fit origin-top-right scale-90 gap-2 rounded-xl border-2 p-2 drop-shadow-xl sm:scale-100"
		>
			<SettingsDatabase />
		</div>
	</div>
